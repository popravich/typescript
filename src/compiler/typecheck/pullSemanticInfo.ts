...
module TypeScript {
    ...
    export class SemanticInfoChain {
        ...
        constructor(private compiler: TypeScriptCompiler, private logger: ILogger) {
            ...
            this.documents[0] = new Document(this.compiler.compilationSettings(), /*fileName:*/ "", /*referencedFiles:*/[], /*scriptSnapshot:*/null, ByteOrderMark.None, /*version:*/"", /*isOpen:*/ false, /*syntaxTree:*/null, globalDecl);
