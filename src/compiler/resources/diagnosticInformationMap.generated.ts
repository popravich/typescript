...
module TypeScript {
  export var diagnosticInformationMap: IIndexable<any> = {
    ...
    "A parameter property is only allowed in a constructor implementation.": { "code": 1040, "category": DiagnosticCategory.Error },
    ...
    "A module cannot have multiple export assignments.": { "code": 1065, "category": DiagnosticCategory.Error },
    ...
    "You must rename an identifier.": { "code": 8000, "category": DiagnosticCategory.Error },
    "You cannot rename this element.": { "code": 8001, "category": DiagnosticCategory.Error },
  };
}