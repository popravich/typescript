...
declare module TypeScript {
    var DiagnosticCode: {
        ...
        You_must_rename_an_identifier: string;
        You_cannot_rename_this_element: string;
    };
}
declare module TypeScript {
...
declare function buildUniqueNameMap(names: string[]): IIndexable<string>;
declare function buildInfoFileOutput(messageTable: InputDiagnosticMessageTable, nameMap: IIndexable<string>): string;
declare function convertPropertyName(origName: string): string;
declare module NameGenerator {
    function ensureUniqueness(names: string[], isFixed?: boolean[], isCaseSensitive?: boolean): string[];
}
declare module Utilities {
    function collectMatchingIndices(name: string, proposedNames: string[], isCaseSensitive?: boolean): number[];
    function stringEquals(s1: string, s2: string, caseSensitive?: boolean): boolean;
